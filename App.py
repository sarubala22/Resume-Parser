...
import nltk
nltk_data_dir = r'C:\Users\saru5\anaconda3\python.exe'  # or use double backslashes
...
connection = pymysql.connect(host='localhost',user='root',password='subbujana',db='cv')
